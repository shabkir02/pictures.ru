...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burger = function burger(burgerMenu, burgerSelector) {
...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFunc = function calcFunc() {
    ...
    if (materialBlock.value == '' || sizeBlock.value == '') {
      resultBlock.textContent = 'Введите размер и материал';
...
var drop = function drop() {
  ...
  ['dragenter', 'dragover', 'drop', 'dragleave'].forEach(function (method) {
  ...
  ['dragenter', 'dragover'].forEach(function (method) {
    fileInputs.forEach(function (input) {
  ...
  ['drop', 'dragleave'].forEach(function (method) {
    fileInputs.forEach(function (input) {
      input.addEventListener(method, function () {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, formData).then(function (res) {
        ...
        statusImg.getAttribute('src', message.fail);
